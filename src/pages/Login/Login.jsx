          ...
          <div className='login'>
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              {formik.touched.username && formik.errors.username ? (
                <div style={{color:"#FF0000", textAlign:"center"}}>{formik.errors.username}</div>
              ) : null}
              <input 
              type="password"
              name="password"
              ...
              {formik.touched.password && formik.errors.password ? (
                <div style={{color:"#FF0000", textAlign:"center"}}>{formik.errors.password}</div>
              ) : null}
              <button type='submit'>Signin</button>
              <div style={{color:"#FF0000", textAlign:"center", marginTop:"3%"}}>{error}</div>
            </form>
          </div>
        </div>
    )
